        ...
        <div class="row Footer-main">
            <div class="row-block"><a class="logo Footer-logo" href="index.html"><img class="logo-image" src="{{asset('assets/img/logo_footer.png')}}" alt="logo_footer.png"/></a>
                ...
                <ul class="menu menu_img menu_smallImg Footer-menuSoc">
                    <li class="menu-item"><a class="menu-link" href="#"><img src="{{asset('assets/img/icons/socialFooter/fb.svg')}}" alt="fb.svg"/></a>
                    </li>
                    <li class="menu-item"><a class="menu-link" href="#"><img src="{{asset('assets/img/icons/socialFooter/tw.svg')}}" alt="tw.svg"/></a>
                    </li>
                    <li class="menu-item"><a class="menu-link" href="#"><img src="{{asset('assets/img/icons/socialFooter/in.svg')}}" alt="in.svg"/></a>
                    </li>
                    <li class="menu-item"><a class="menu-link" href="#"><img src="{{asset('assets/img/icons/socialFooter/pt.svg')}}" alt="pt.svg"/></a>
                    </li>
                    <li class="menu-item"><a class="menu-link" href="#"><img src="{{asset('assets/img/icons/socialFooter/mail.svg')}}" alt="mail.svg"/></a>
                    </li>
                </ul>
            </div>
            <div class="row-block">
            ...
            <div class="row row_space">
                ...
                <div class="row-block"><span>Accepted Payments</span>
                    <div class="Footer-payments">
                        <div><img src="{{asset('assets/img/payments/visa.png')}}" alt="visa.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/mastercard.png')}}" alt="mastercard.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/paypal.png')}}" alt="paypal.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/american.png')}}" alt="american.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/electron.png')}}" alt="electron.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/maestro.png')}}" alt="maestro.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/delta.png')}}" alt="delta.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/e.png')}}" alt="e.png"/>
                        </div>
                        <div><img src="{{asset('assets/img/payments/dk.png')}}" alt="dk.png"/>
                        </div>
                    </div>
                </div>
            </div>
