            ...
            <div class="Section-columnSection">
                ...
                <div class="Section-columnContent">
                    <ul class="menu menu_vt Order-navigate">
                        <li class="menu-item_ACTIVE menu-item"><a class="menu-link" href="#step1">{{__('checkout.step1')}}</a></li>
                        ...
                        <li class="menu-item"><a class="menu-link" href="#step4">{{__('checkout.step4')}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
